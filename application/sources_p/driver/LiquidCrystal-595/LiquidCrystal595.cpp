...
#define ENABLE_PIN		0B00001000
#define LED2_PIN		0B00000100  //RW
#define RS_PIN			0B00000010
#define LED1_PIN		0B00000001  //backlight
#define DATABITS		0B11110000
...
//	io_hc595_put_data1(_register);
//	io_hc595_put_data2(_register);
}
